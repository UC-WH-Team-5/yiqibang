(function (e, t) {
    ...
    function r(e) {
        var t = {}, n = e.createElement, r = e.createDocumentFragment, o = r();
    ...
    function u(e) {
        var t, i, r = e.namespaces, o = e.parentWindow;
        return !y || e.printShived ? e : (r[b] === void 0 && r.add(b), o.attachEvent("onbeforeprint", function () {
            ...
            for (; s = h.pop();)if (!s.disabled && v.test(s.media)) {
    ...
    var d, h, p = e.html5 || {}, f = /^<|^(?:button|form|map|select|textarea|object|iframe)$/i, g = /^<|^(?:a|b|button|code|div|fieldset|form|h1|h2|h3|h4|h5|h6|i|iframe|img|input|label|li|link|ol|option|p|param|q|script|select|span|strong|style|table|tbody|td|textarea|tfoot|th|thead|tr|ul)$/i;
    (function () {
    ...
    e.html5 = m, o(t);
    var v = /^$|\b(?:all|print)\b/, b = "html5shiv", y = !h && function () {
