...
public class TNews {
	...
	public String toString() {
		return "TNews [id=" + id + ", tTId=" + tTId + ", nPics=" + nPics + ", nTitle=" + nTitle + ", nSource=" + nSource
				+ ", nCreatetime=" + nCreatetime + ", nReadcount=" + nReadcount + ", nCommcount=" + nCommcount
				+ ", nAuthor=" + nAuthor + ", nSharecount=" + nSharecount + ", nIfhot=" + nIfhot + ", nIfreport="
				+ nIfreport + ", nContent=" + nContent + "]";
	}

	
	public TNews(Integer id, Integer tTId, String nPics, String nTitle, String nSource, Date nCreatetime,
			Integer nReadcount, Integer nCommcount, String nAuthor, Integer nSharecount, Boolean nIfhot,
			Boolean nIfreport, String nContent) {
//		super();
		this.id = id;
		this.tTId = tTId;
		this.nPics = nPics;
